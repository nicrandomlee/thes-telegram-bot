...
def update_frail_senior_message_response_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    target_senior_name = context.user_data['name_of_frail_senior_to_be_updated']
    ...
    return f"Successfully updated {target_senior_name}'s status. To update another senior's updates, run /update_frail_seniors_message"